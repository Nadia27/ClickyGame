...
class App extends Component {
  ...
  handleReset = () => {
    this.setState({
      ...
      guessStatus: "Ha Ha you're wrong!!",
      clicked: []
    });
    this.handleShuffle();
  };
  ...
  render() {
    return (
      ...
      <Wrapper>
        ...
        <Title>
          Click on an classic Hip-Hop album to earn points! You loose if you click on any album more than once!
        </Title>
